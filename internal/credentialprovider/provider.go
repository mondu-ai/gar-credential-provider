...
// Provider handles kubelet credential requests.
...
// New creates a Provider with the given token fetcher.
...
// Examples:
//   - "us-central1-docker.pkg.dev/project/repo/image:tag" → "us-central1-docker.pkg.dev"
