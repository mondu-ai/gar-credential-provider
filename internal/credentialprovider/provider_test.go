...
func TestHandleRequest_Success(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			image:            "us-central1-docker.pkg.dev/some-name/repo/image:v1.0.0",
			expectedRegistry: "us-central1-docker.pkg.dev",
		},
		{
...
func TestExtractRegistry(t *testing.T) {
	tests := []struct {
		...
		{"us-central1-docker.pkg.dev/project/repo/image:tag", "us-central1-docker.pkg.dev", false},
